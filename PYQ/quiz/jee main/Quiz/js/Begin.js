...
function CheckResult() {
    ...
    $(".test-questions").find("li").each(function (ind) {
        ...
        if (r.children().hasClass("que-save") || r.children().hasClass("que-save-mark")) {
            ...
            if ((ind <= 19) || (ind > 29 && ind <= 49) || (ind > 59 && ind <= 79)) {
            ...
            if (ansStatus == 'Correct') {
                ...
                if ((ind <= 90) || (ind > 129 && ind <= 149) || (ind > 159 && ind <= 179))
                    score = score - 1;
...
$(document).ready(function () {
    ...
    $(".btn-save-answer").click(function (e) {
        e.preventDefault();
        if(parseInt(localStorage.getItem("clickCount")) >= 5 && $(".test-questions li.active").hasClass("MS2")){      
            $('#myModal1').click();
            return false;                
        }
        if(parseInt(localStorage.getItem("phyclickCount")) >= 5 && $(".test-questions li.active").hasClass("PS2")){      
            $('#myModal1').click();
            return false;                
        }
        if(parseInt(localStorage.getItem("checlickCount")) >= 5 && $(".test-questions li.active").hasClass("CS2")){      
            $('#myModal1').click();
            return false;                
        }
            var t = $(".test-questions").find("li.active"),
        ...
        listItems.each(function(ddd, li) {
             if( ( currentClick >=21 && currentClick <=30 )){ 
        ...
        //ekd of math
         ...
         listItemsphy.each(function(ddd, li) {
             if( ( currentphyClick >=51 && currentphyClick <=60 )){   
         ...
         listItemsche.each(function(ddd, li) {
             if( ( currentCheClick >=81 && currentCheClick <=90 )){                 
                 if($(li).hasClass("que-save")){
    ...
    $(".btn-reset-answer").click(function (e) {
        ...
        if( localStorage.getItem("phyclickCount")){
            let updateCnt = parseInt(localStorage.getItem("phyclickCount"));
            localStorage.setItem("phyclickCount",(updateCnt-1));
        }
        if( localStorage.getItem("checlickCount")){
            let updateCnt = parseInt(localStorage.getItem("checlickCount"));
            localStorage.setItem("checlickCount",(updateCnt-1));
        }
